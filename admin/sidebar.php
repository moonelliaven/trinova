<p class="menu-header">HALAMAN UTAMA</p>
<ul>
...
<ul>
    ...
    <li><a href="../logout.php" onclick="return confirm('Apakah Anda yakin ingin logout?')"><i class="fas fa-sign-out-alt"></i> Logout</a></li>
</ul>